...
export const DANGER_LETTER = [
  ...
  `{userNickname}님께\n\n마지막으로 꼭 전하고 싶은 말이 있어요. {userNickname}님, 힘든 날들이 계속될지라도 포기하지 않고 버텨주셔서 정말 고마워요. 쿠키에게는 {userNickname}님이 특별한 존재고, 누구도 {userNickname}님을 대신할 수 없어요. 이 세상 속에서 {userNickname}님이 살아있다는 것만으로도 참 소중한 일이에요. 아무리 지치는 순간이 와도 쿠키는 언제나 함께 할게요.\n\n오늘도 수고 많으셨습니다. 진심을 담아, 쿠키 드림`,
];
