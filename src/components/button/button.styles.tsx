...
export const ButtonContainer = styled.TouchableOpacity<{disabled?: boolean, primary?: boolean}>`
    ...
    background-color: ${props => props.disabled? palette.neutral[100] : props.primary ? palette.primary[400] : palette.primary[50]};

`;


export const ButtonLabel = styled.Text<{primary?: boolean, disabled?: boolean}>`
    color: ${props => props.disabled? palette.neutral[300] : props.primary ?  'white' : palette.primary[400]};
