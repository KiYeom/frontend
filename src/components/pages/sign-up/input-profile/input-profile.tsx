...
const InputProfile: React.FC<any>  = ({navigation}) => {
    ...
    return (
    <>
        <TitleContaienr><Annotation>{name}님을 더 잘 이해하고 싶어요.</Annotation>
        <Title>쿠키에게{"\n"}정보를 알려주세요.</Title>
        </TitleContaienr>
        <ContentContainer>
            <FormContainer>
            ...
            <FormContainer>
                <Label>성별</Label>
                <ButtonGroup>
                <GenderButton activeOpacity={1} selected={gender === "여성"} onPress={() => setGender("여성")}><BtnLabel selected={gender === "여성"}>여성</BtnLabel></GenderButton>
                <GenderButton activeOpacity={1} selected={gender === "남성"} onPress={() => setGender("남성")}><BtnLabel selected={gender === "남성"}>남성</BtnLabel></GenderButton>
                </ButtonGroup>
            </FormContainer>
        </ContentContainer>
