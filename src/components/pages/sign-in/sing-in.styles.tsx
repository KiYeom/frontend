...
background-color: ${props => props.vendor === 'kakao' ? '#FEE500' : props.vendor === 'google' ? 'white' : 'black'};
...
export const LoginBtnLabel = styled.Text<{vendor: 'kakao' | 'google' | 'apple'}>`
  ...
  color: ${(props) => props.vendor === 'kakao' ? 'black' : props.vendor === 'google' ? 'rgba(0,0,0,0.54)' : '#FFFFFF'};
`;
