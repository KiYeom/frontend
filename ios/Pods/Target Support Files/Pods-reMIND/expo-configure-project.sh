...
with_node \
  ...
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo-apple-authentication" "expo-asset" "expo-constants" "expo-crypto" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake" "expo-random" "expo-web-browser"
